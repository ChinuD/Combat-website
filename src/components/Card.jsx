...
function Card() {
  return (
    <>
      <div class="bg-gray-800 text-white rounded-lg p-4 w-40 shadow-lg">
        ...
        <div class="text-center">
          ...
          {/* <p class="text-sm mt-2">Compas win</p> */}
          <button class="bg-green-600 text-xs uppercase py-1 px-3 rounded mt-3 hover:bg-green-500">
            Scorecard
          </button>
